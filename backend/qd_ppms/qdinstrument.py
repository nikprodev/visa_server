...
class QDInstrument:
    ...
    def get_pressure(self):
        ...
        arg0 = win32com.client.VARIANT(pythoncom.VT_BYREF | pythoncom.VT_R8, 0.0)
        arg1 = win32com.client.VARIANT(pythoncom.VT_BYREF | pythoncom.VT_I4, 0)
        err = self._mvu.GetPressure(arg0, arg1)
        return err, arg0.value, arg1.value

    def get_position(self):
        """Gets rotator position"""
        arg0 = win32com.client.VARIANT(pythoncom.VT_BYREF | pythoncom.VT_BSTR, "Horizontal Rotator")
        arg1 = win32com.client.VARIANT(pythoncom.VT_BYREF | pythoncom.VT_R8, 0)
        arg2 = win32com.client.VARIANT(pythoncom.VT_BYREF | pythoncom.VT_I4, 0)
        err = self._mvu.GetPosition(arg0, arg1, arg2)
        # Vars order changed in output (!)
        return err, arg1.value, arg2.value

    def set_position(self, position, speed, mode):
        """Set rotator position"""
        err = self._mvu.SetPosition("Horizontal Rotator", position, speed, mode)
        return err
